...
export default function EditCourse ({match}){
    ...
    // p/implementar la vista, este componente primero cargara los detalles del curso llamando al metodo read
    useEffect(() => {
    ...
    // p/ manejar los cambios realizados en los valores de cada campo,este metodo tomata el nombre de campo y el indice de la leccion corresp en la matriz
    ...
    // cdo el usuario hace click en este boton la leccion del indice actual se movera hacia arrina, y la leccion anterior tomara su lugar en la matriz
    ...
    // cdo se hace click en el boton eliminar, tomaremos en indice de la leccion q se esta eliminando y la eliminaremos de la matriz de lecciones
    ...
    // envia los datos a traves de del boton submit
    const clickSubmit = () => {
