...
export default function FindPeople() {
    ...
    // buscaremos los usuarios que no estan siendo seguidos llamando al metodo finPeople
    // leer sobre put/suscribe arquetectura
    useEffect(() => {
    ...
    // al hacer click en el boton se llamara a la ap de seguimiento y se actualizara la lista de usuarios a seguir separado de los recien seguidos 
