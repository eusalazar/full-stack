...
export default function Post(props) {
    ...
    // conteo de MG establecen el valor de mg e el estado props.post.likes.length
    ...
    // gestiona los botones de mg y NoMg, llamaremos al metodo de busqueda apropiado en funcion de si es un Mg o NoMg
    const clickLike = () => {
    ...
    // permitira el recuento de comentarios eliminados o agregados
    const updateComments = (comments) => {
        setValues({...values, comments: comments})
    }


    // se como props desd newsfeed o Profile p/actualizar la lista de publicaciones en el estado  cdo la eliminacion en es exitosa
    const deletePost = () => {   
        remove({
