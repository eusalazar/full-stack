...
export default function Comments (props) {
    ...
    // corresponde al evento enviar comentario
    ...
    return (<div>
        ...
        />
        { props.comments.map((item, i) => {   {/* itera sobre los comentarios individuales para representarlos detalles del comentarista y el contenido del comentario*/}
            return <CardHeader
                avatar={
